...
def test_id():
    assert (
        item["id"] == "det_zoning_appeals/201902260900/x/board_of_zoning_appeals_docket"
    )
    ...
    assert item["links"] == [
        {
            ...
            "href": "https://detroitmi.gov/sites/detroitmi.localhost/files/events/2019-02/Feb%2026%2C%202019.pdf",  # noqa
        }
    ]
