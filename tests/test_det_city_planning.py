...
test_response = file_response(
    join(dirname(__file__), "files", "det_city_planning.html"),
...
def test_source():
    assert (
        item["source"]
        == "https://detroitmi.gov/events/city-planning-commission-meeting-0"
    )  # noqa
...
def test_links():
    assert item["links"] == [
        {
            "href": "https://detroitmi.gov/sites/detroitmi.localhost/files/events/2019-01/January%2017%2C%202019%20agenda.pdf",  # noqa
            "title": "January 17, 2019 agenda.pdf",
        },
        {
            "href": "https://detroitmi.gov/sites/detroitmi.localhost/files/events/2019-01/PH%202019-01-17%20515PM.pdf",  # noqa
            "title": "PH 2019-01-17 515PM.pdf",
        },
        {
            "href": "https://detroitmi.gov/sites/detroitmi.localhost/files/events/2019-01/PH%202019-01-17%20600%20PM.pdf",  # noqa
