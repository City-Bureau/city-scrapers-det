...
def test_links():
    assert parsed_items[0]["links"] == [
        {
            "title": "Agenda",
            "href": "https://www.waynecounty.com/documents/commission/fullboard011118.pdf",  # noqa
        },
        {
            "title": "Journal",
            "href": "https://www.waynecounty.com/documents/commission/journal2018-111.pdf",  # noqa
        },
    ]
...
def test_id():
    assert (
        parsed_items[0]["id"] == "wayne_full_commission/201801111000/x/full_commission"
    )
