...
test_prev_response = file_response(
    join(
        dirname(__file__), "files", "det_local_development_finance_authority_prev.html"
    ),
...
def test_prev_links():
    assert parsed_prev_items[1]["links"] == [
        ...
        {
            "href": "http://www.degc.org/wp-content/uploads/12-12-17-Special-LDFA-Board-Meeting-Agenda-Only.pdf",  # noqa
