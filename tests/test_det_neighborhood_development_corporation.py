...
freezer = freeze_time("2017-01-29")
...
test_prev_response = file_response(
    join(
        dirname(__file__), "files", "det_neighborhood_development_corporation_prev.html"
    ),
...
def test_prev_links():
    assert parsed_prev_items[0]["links"] == [
        {
            "href": "http://www.degc.org/wp-content/uploads/2017-06-27-NDC-Board-Meeting-Agenda.pdf",  # noqa
