...
from city_scrapers.spiders.wayne_government_operations import (
    WayneGovernmentOperationsSpider,
)
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "wayne_government_operations/201801090930/x/committee_on_government_operations"  # noqa
    )
