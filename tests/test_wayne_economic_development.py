...
from city_scrapers.spiders.wayne_economic_development import (
    WayneEconomicDevelopmentSpider,
)

freezer = freeze_time("2018-03-27")
freezer.start()
test_response = file_response(
    join(dirname(__file__), "files", "wayne_economic_development.html"),
...
def test_links():
    assert parsed_items[0]["links"] == [
        {
            "title": "Agenda",
            "href": "https://www.waynecounty.com/documents/commission/edcnotice2018_jan9.pdf",  # noqa
        }
    ]
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "wayne_economic_development/201801091100/x/committee_on_economic_development"
    )
