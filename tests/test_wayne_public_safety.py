...
def test_title(item):
    assert (
        item["title"] == "Committee on Public Safety, Judiciary, and Homeland Security"
    )
...
def test_links():
    assert parsed_items[0]["links"] == [
        {
            "title": "Agenda",
            "href": "https://www.waynecounty.com/documents/commission/psjnotice20178_jan17.pdf",  # noqa
        }
    ]
