...
from city_scrapers.spiders.wayne_health_human_services import (
    WayneHealthHumanServicesSpider,
)
...
def test_links():
    assert parsed_items[0]["links"] == [
        {
            "title": "Agenda",
            "href": "https://www.waynecounty.com/documents/commission/hhsagenda_2018-0109.pdf",  # noqa
        }
    ]
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "wayne_health_human_services/201801091330/x/committee_on_health_and_human_services"  # noqa
    )
