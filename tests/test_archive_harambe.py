...
def test_filter_harambe_meetings():
    ...
    meetings = [
        {"extras": {"cityscrapers.org/id": "det_city_council/2025/meeting"}},
        {"extras": {"cityscrapers.org/id": "det_dwcpa/2025/meeting"}},
        {
            "extras": {
                "cityscrapers.org/id": "det_great_lakes_water_authority/2025/meeting"
            }
        },
    ]

    result = filter_harambe_meetings(
        meetings, ["det_dwcpa", "det_great_lakes_water_authority"]
    )
...
def test_filter_harambe_meetings_empty():
    ...
    meetings = [{"extras": {"cityscrapers.org/id": "det_city_council/2025/meeting"}}]

    result = filter_harambe_meetings(meetings, ["det_dwcpa"])
...
def test_get_urls_to_archive_with_legistar():
    ...
    meeting = {
        "sources": [{"url": "https://glwater.legistar.com/View.ashx?M=A&ID=123"}],
...
def test_get_urls_to_archive_calendar_excluded():
    ...
    meeting = {
        "sources": [{"url": "https://glwater.legistar.com/Calendar.aspx"}],
        "links": [],
    }
